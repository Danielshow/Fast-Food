...
router.put('/menu/:id', _checkAuth2.default.verifyAdminToken, _multer_config2.default.single('foodImage'), [_shared2.default.verifyBody, _read_file2.default.isFoodAvailable], _menu2.default.updateFood);
