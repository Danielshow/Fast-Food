...
router.post('/auth/signup/admin', checkAuth.verifyAdminToken, [body.verifyBody, body.isPasswordValid, body.confirmPassword, body.validate, body.isEmailExist], AuthController.adminRegister);
